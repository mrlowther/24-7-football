...
export default function About() {
    return (
      ...
      <Typography variant="h3">NFL Player Stats, Made Easy!</Typography>

      <Typography variant="h5">Some kids love football. Some kids love stats. Some kids love both!</Typography>
